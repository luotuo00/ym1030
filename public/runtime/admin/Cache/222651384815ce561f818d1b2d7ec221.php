	...
	<table class="form" cellpadding=0 cellspacing=0>
		...
		<tr>
			<td class="item_title" style="width:200px;">
				<input type="button" class="button ajaxclear" value="清空临时数据缓存"  rel="<?php echo u("Cache/clear_data",array("is_all"=>0));?>"/>
			</td>
			<td class="item_input">
				清空程序的临时数据缓存
			</td>
		...
		<?php /*<tr>
			<td class="item_title" style="width:200px;">
				<input type="button" class="button" id="syn_data" value="同步数据索引"  rel="<?php echo u("Cache/syn_data");?>"/>
			</td>
			<td class="item_input">
				当分类，地区，商圈，标签，属性数据有修改同步商户，商品，优惠券，团购的数据分类标签及地址的搜索索引。<br />
				该操作比较耗时与占用系统资源，<span style="color:#f30;">请谨慎操作</span><br />
				如果产品，优惠券数据庞大，建议手动单独更新需要的数据
			</td>
		</tr>*/ ?>
		<tr>
